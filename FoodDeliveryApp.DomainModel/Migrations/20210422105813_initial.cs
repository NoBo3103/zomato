        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostForTwo = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollwerId = table.Column<int>(type: "integer", nullable: true),
                    FollowedById = table.Column<int>(type: "integer", nullable: false),
                    FollowById = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Follows_Users_FollowById",
                        column: x => x.FollowById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Follows_Users_FollwerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Follows_FollowById",
                table: "Follows",
                column: "FollowById");

            migrationBuilder.CreateIndex(
                name: "IX_Follows_FollwerId",
                table: "Follows",
                column: "FollwerId");
